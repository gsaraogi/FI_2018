...
public class export_odi_objects
{ 
...
public static void export_scen (obj_name)
{
...
public static void export_pack (obj_name)
{
...
public static void export_map (obj_name)
{
...
public static void export_proc (obj_name)
{
...
{		
   while ((line = br.readLine()) != null) 
  {
		...
		{
		export_scen(obj_name);
		}
		
		if ( obj_type == 'package' )
		{
		export_pack(obj_name);
		}
